...
export default function leftpanel() {
  return (
    <section
      className={`w-[18%]  relative pt-12 border-r border-gray-700`}
    >
      <div className="naver max-w-full  fixed  h-full">
        ...
        <nav className="flex mt-8 flex-col">
          ...
          <div className="flex flex-col mx-2 gap-3 pt-12">
            <a
              className={`rounded-full text-xl px-4 py-3 bg-white font-semibold text-black text-center`}
              href="#"
            >
              Post
            </a>
            <a
              className={`rounded-full text-xl px-4 py-3 bg-blue-500 font-semibold text-white text-center`}
              href="#"
            >
              ads
            </a>
